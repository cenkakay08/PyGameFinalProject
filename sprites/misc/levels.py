...
def createLevel(game, levelIndex):
    ...
    if levelIndex == 1:
        ...
        platform = [(TILE_W*4, HEIGHT-TILE_H*2, TILE_W*32, TILE_H),(TILE_W*15, TILE_H*24, TILE_W*10, TILE_H),(TILE_W*17, TILE_H*21, TILE_W*6, TILE_H),(TILE_W*18, TILE_H*19, TILE_W*4, TILE_H),(TILE_W*2, TILE_H*17, TILE_W*14, TILE_H),(TILE_W*23, TILE_H*17, TILE_W*14, TILE_H),(TILE_W*4, TILE_H*10, TILE_W*14, TILE_H),(TILE_W*21, TILE_H*10, TILE_W*14, TILE_H),(TILE_W*8, TILE_H*4, TILE_W*22, TILE_H)]
        ladder = [(TILE_W*8, TILE_H*9, TILE_H*8),(TILE_W*29, TILE_H*9, TILE_H*8),(TILE_W*13, TILE_H*3, TILE_H*7)]
        coi = [(TILE_W*28, TILE_H*19, game.player),(TILE_W*14, TILE_H*13, game.player),(TILE_W*19, TILE_H*13, game.player),(TILE_W*4, TILE_H*8, game.player),(TILE_W*19, TILE_H*7, game.player),(TILE_W*34, TILE_H*7, game.player),(TILE_W*26, TILE_H, game.player)]
