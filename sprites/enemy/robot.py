...
class Robot(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.stand_frames_r = pygame.image.load(
            "resources/image/enemy/robot/stand.png").convert_alpha()
        self.stand_frames_l = pygame.transform.flip(
            self.stand_frames_r, True, False)
        self.climb_frames_r = [pygame.image.load("resources/image/enemy/robot/stand.png").convert_alpha(
        ), pygame.image.load("resources/image/enemy/robot/climb.png").convert_alpha()]
        self.climb_frames_l = []
        for frame in self.climb_frames_r:
            self.climb_frames_l.append(
                pygame.transform.flip(frame, True, False))
        self.run_frames_r = [pygame.image.load("resources/image/enemy/robot/run_1.png").convert_alpha(), pygame.image.load("resources/image/enemy/robot/run_2.png").convert_alpha(), pygame.image.load(
            "resources/image/enemy/robot/run_3.png").convert_alpha(), pygame.image.load("resources/image/enemy/robot/run_4.png").convert_alpha(), pygame.image.load("resources/image/enemy/robot/run_5.png").convert_alpha()]
        self.run_frames_l = []
    ...
    def update(self):
        ...
        hits = pygame.sprite.collide_mask(self.game.player, self)
        if hits:
    ...
    def animate(self):
        ...
        if self.isClimbing:
            if now - self.last_update > 200:
                ...
                self.current_frame = (
                    self.current_frame + 1) % len(self.climb_frames_r)
